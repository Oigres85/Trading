...
const SUITE = [
  ...
  { file: "test_app.mjs",        cmd: "node",    minimo: 557, firma: /\d+\/\d+ check superati/ },
  { file: "test_update_data.py", cmd: "python3", minimo: 188, firma: /CHECK OK|CHECK FALLITI/ },
  ...
  { file: "test_analisi_libro.py", cmd: "python3", minimo: 120, firma: /\d+\/\d+ CHECK OK/ },
