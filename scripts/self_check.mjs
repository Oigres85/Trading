...
const SUITE = [
  ...
  { file: "test_app.mjs",        cmd: "node",    minimo: 545, firma: /\d+\/\d+ check superati/ },
  { file: "test_update_data.py", cmd: "python3", minimo: 185, firma: /CHECK OK|CHECK FALLITI/ },
  ...
  { file: "test_analisi_libro.py", cmd: "python3", minimo: 108, firma: /\d+\/\d+ CHECK OK/ },
