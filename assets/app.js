...
B. ESECUZIONE COMPLETA: per OGNI operazione suggerita (COMPRA o VENDI) fornisci SEMPRE il calcolo MATEMATICO ESATTO della quantità di quote. Regola di sizing: dimensiona sul budget disponibile ricordando di MANTENERE SEMPRE una quota di liquidità di sicurezza strategica (Dry Powder, es. ~15.000 € o quota proporzionale) per eventuali drawdown. Mostra il conto (es. "budget allocato 5.000$ ÷ prezzo 180$ = 27 quote. Liquidità residua preservata").
